...
export default function ReceivedContactsPage() {
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mb-4 flex items-start gap-3">
                <div className="flex-shrink-0 rounded-lg bg-gradient-to-br from-violet-100 to-purple-100 p-2.5 shadow-sm">
              ...
              {/* 임대인 메시지 */}
              <div className="relative mb-5 rounded-xl bg-gradient-to-br from-violet-50 to-purple-50 p-4 shadow-sm">
                <div className="absolute -left-1.5 top-3 h-3 w-3 rotate-45 bg-gradient-to-br from-violet-50 to-purple-50"></div>
                <div className="mb-1.5 flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-bold text-purple-700">임대인 메시지</span>
                </div>
              ...
              <div className="flex flex-wrap items-end justify-between gap-2.5">
                <div className="flex flex-wrap items-center gap-2.5">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-lg border-2 border-purple-600 bg-white px-4 py-2 text-sm font-semibold text-purple-700 shadow-sm transition-all hover:bg-purple-50"
                  >
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
