...
// import { getMyHousePlatforms } from '@/lib/repositories/ownerRepository';
...
//   const [listings, setListings] = useState<HousePlatform[]>([]);
...
//       setListings(data);
//       const contactData = await getSentMessages();
//       setContacts(contactData);
//     })();
//   }, []);

//   const pendingContacts = contacts.filter((c) => c.acceptType === 'W').length;
...
//             <Button className="rounded-xl px-5 py-2.5" onClick={() => (window.location.href = '/owner/listings/new')}>
//               매물 등록하기
//             </Button>
//             <Button
...
//           </div>
//           <Button className="mt-4 w-full rounded-xl py-3" onClick={() => (window.location.href = '/owner/contacts')}>
//             컨택 요청 현황 보기
//           </Button>
//         </Card>
//       </div>
...
//           <Link className="rounded-full border border-emerald-100 bg-emerald-50 px-3 py-2 text-emerald-800 transition hover:-translate-y-0.5 hover:border-emerald-200" href="/owner/listings/new">
//             매물 등록하기
//           </Link>
//           <Link className="rounded-full border border-emerald-100 bg-emerald-50 px-3 py-2 text-emerald-800 transition hover:-translate-y-0.5 hover:border-emerald-200" href="/owner/listings">
//             내 매물 목록 보기
//           </Link>
//           <Link className="rounded-full border border-sky-100 bg-sky-50 px-3 py-2 text-sky-800 transition hover:-translate-y-0.5 hover:border-sky-200" href="/owner/contacts">
//             컨택 요청 보기
//           </Link>
//         </div>
//       </Card>
