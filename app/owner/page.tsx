...
import { getOwnerContacts, getOwnerListings } from '@/lib/repositories/ownerRepository';
...
export default function OwnerHomePage() {
  ...
  useEffect(() => {
    (async () => {
      const data = await getOwnerListings('owner-1');
      setListings(data);
      const contactData = await getOwnerContacts('owner-1');
